...
async function init(){
  CATALOG=await getJSON('assets/data/catalog-v4-1-0.json?v='+ASSET_VERSION);
  if(!CATALOG || !Array.isArray(CATALOG.groupOrder) || !CATALOG.groups || !CATALOG.topics){
    throw Error('Katalog Portal v4.1.0 tidak lengkap. Muat ulang halaman atau bersihkan cache situs.');
  }
